...
export default class Controls extends EventEmitter {
    ...
    setTouch() {
        ...
        this.touch.joystick.resize = () => {
            const boundings =
                this.touch.joystick.$element.getBoundingClientRect();
        ...
        this.time.on("tick", () => {
            ...
            if (this.touch.joystick.active) {
                ...
                const cursorX =
                    Math.sin(
                        this.touch.joystick.angle.originalValue + Math.PI * 0.5
                    ) * radius;
                const cursorY =
                    Math.cos(
                        this.touch.joystick.angle.originalValue + Math.PI * 0.5
        ...
        this.touch.joystick.events.touchmove = (_event) => {
            ...
            const touch = touches.find(
                (_touch) =>
                    _touch.identifier === this.touch.joystick.touchIdentifier
            );
        ...
        this.touch.boost.events.touchend = (_event) => {
            ...
            const touch = touches.find(
                (_touch) =>
                    _touch.identifier === this.touch.boost.touchIdentifier
            );
        ...
        this.touch.boost.$element.addEventListener(
            "touchstart",
            this.touch.boost.events.touchstart
        );
        ...
        this.touch.forward.events.touchend = (_event) => {
            ...
            const touch = touches.find(
                (_touch) =>
                    _touch.identifier === this.touch.forward.touchIdentifier
            );
        ...
        this.touch.forward.$element.addEventListener(
            "touchstart",
            this.touch.forward.events.touchstart
        );
        ...
        this.touch.brake.events.touchend = (_event) => {
            ...
            const touch = touches.find(
                (_touch) =>
                    _touch.identifier === this.touch.brake.touchIdentifier
            );
        ...
        this.touch.brake.$element.addEventListener(
            "touchstart",
            this.touch.brake.events.touchstart
        );
        ...
        this.touch.backward.events.touchend = (_event) => {
            ...
            const touch = touches.find(
                (_touch) =>
                    _touch.identifier === this.touch.backward.touchIdentifier
            );
        ...
        this.touch.backward.$element.addEventListener(
            "touchstart",
