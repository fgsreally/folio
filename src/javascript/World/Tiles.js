...
export default class Tiles {
    ...
    setModels() {
        ...
        const totalChances = this.models.items.reduce(
            (_totalChances, _item) => _totalChances + _item.chances,
            0
        );
        let chances = 0;
        ...
        this.models.pick = () => {
            ...
            const model = this.models.items.find(
                (_item) =>
                    random >= _item.minChances && random <= _item.maxChances
            );
            model.rotationIndex++;
