...
export default class Physics {
    ...
    setCar() {
        ...
        this.car.jump = (_toReturn = true, _strength = 60) => {
            ...
            worldPosition = worldPosition.vadd(
                new CANNON.Vec3(_toReturn ? 0.08 : 0, 0, 0)
            );
            this.car.chassis.body.applyImpulse(
                new CANNON.Vec3(0, 0, _strength),
                worldPosition
            );
        };
        ...
        this.car.create = () => {
            ...
            this.car.chassis.body = new CANNON.Body({
                mass: this.car.options.chassisMass,
            });
            this.car.chassis.body.allowSleep = false;
            this.car.chassis.body.position.set(0, 0, 12);
            this.car.chassis.body.sleep();
            this.car.chassis.body.addShape(
                this.car.chassis.shape,
                this.car.options.chassisOffset
            );
            this.car.chassis.body.quaternion.setFromAxisAngle(
            ...
            this.car.wheels.options = {
                ...
                suspensionRestLength:
                    this.car.options.wheelSuspensionRestLength,
                ...
                customSlidingRotationalSpeed:
                    this.car.options.wheelCustomSlidingRotationalSpeed,
            ...
            this.car.wheels.options.chassisConnectionPointLocal.set(
                this.car.options.wheelFrontOffsetDepth,
                this.car.options.wheelOffsetWidth,
                0
            );
            ...
            // Back left
            this.car.wheels.options.chassisConnectionPointLocal.set(
                this.car.options.wheelBackOffsetDepth,
                this.car.options.wheelOffsetWidth,
                0
            );
            this.car.vehicle.addWheel(this.car.wheels.options);
            ...
            for (const _wheelInfos of this.car.vehicle.wheelInfos) {
                const shape = new CANNON.Cylinder(
                    _wheelInfos.radius,
                    _wheelInfos.radius,
                    this.car.wheels.options.height,
                    20
                );
                const body = new CANNON.Body({
                    mass: this.car.options.wheelMass,
        ...
        this.world.addEventListener("postStep", () => {
            ...
            this.car.chassis.body.vectorToWorldFrame(
                localForward,
                this.car.worldForward
            );
            this.car.angle = Math.atan2(
                this.car.worldForward.y,
                this.car.worldForward.x
            );
                ...
                if (this.car.upsideDown.state === "watching") {
                    ...
                    this.car.upsideDown.pendingTimeout = window.setTimeout(
                        () => {
                            ...
                            this.car.upsideDown.turningTimeout =
                                window.setTimeout(() => {
            ...
            if (!this.controls.actions.up && !this.controls.actions.down) {
                ...
                slowDownForce = slowDownForce.scale(
                    this.car.chassis.body.velocity.length() * 0.1
                );
        ...
        this.time.on("tick", () => {
            ...
            this.car.model.chassis.position
                .copy(this.car.chassis.body.position)
                .add(this.car.options.chassisOffset);
            ...
            if (this.controls.touch) {
                ...
                if (this.controls.touch.joystick.active) {
                    ...
                    deltaAngle =
                        ((this.controls.touch.joystick.angle.value -
                            this.car.angle +
                            Math.PI) %
                            (Math.PI * 2)) -
                        Math.PI;
                ...
                const goingForward =
                    Math.abs(this.car.forwardSpeed) < 0.01
                        ? true
                        : this.car.goingForward;
                this.car.steering = deltaAngle * (goingForward ? -1 : 1);

                // Clamp steer
                if (
                    Math.abs(this.car.steering) >
                    this.car.options.controlsSteeringMax
                ) {
                    this.car.steering =
                        Math.sign(this.car.steering) *
                        this.car.options.controlsSteeringMax;
                }
            }
            ...
            if (!this.controls.touch || !this.controls.touch.joystick.active) {
                const steerStrength =
                    this.time.delta * this.car.options.controlsSteeringSpeed;
                ...
                // Steer center
                    ...
                    if (Math.abs(this.car.steering) > steerStrength) {
                        this.car.steering -=
                            steerStrength * Math.sign(this.car.steering);
                    } else {
                        this.car.steering = 0;
                    }
                }
            ...
            this.car.vehicle.setSteeringValue(
                -this.car.steering,
                this.car.wheels.indexes.frontLeft
            );
            this.car.vehicle.setSteeringValue(
                -this.car.steering,
                this.car.wheels.indexes.frontRight
            );

            if (this.car.options.controlsSteeringQuad) {
                this.car.vehicle.setSteeringValue(
                    this.car.steering,
                    this.car.wheels.indexes.backLeft
                );
                this.car.vehicle.setSteeringValue(
                    this.car.steering,
                    this.car.wheels.indexes.backRight
                );
            }
            ...
            const controlsAcceleratinMaxSpeed = this.controls.actions.boost
            ...
            if (this.controls.actions.up) {
                if (
                    this.car.speed < controlsAcceleratinMaxSpeed ||
                    !this.car.goingForward
                ) {
            ...
            if (this.controls.actions.brake) {
                this.car.vehicle.setBrake(
                    this.car.options.controlsBrakeStrength,
                    0
                );
                this.car.vehicle.setBrake(
                    this.car.options.controlsBrakeStrength,
        ...
        // Debug
        if (this.debug) {
            this.car.debugFolder = this.debugFolder.addFolder({
                title: "car",
                expanded: false,
            });
            this.car.debugFolder
                .addInput(this.car.options, "chassisWidth", {
                    label: "chassisWidth",
                    min: 0,
                    max: 5,
                })
                .on("change", this.car.recreate);

            this.car.debugFolder
                .addInput(this.car.options, "chassisDepth", {
                    label: "chassisDepth",
                    min: 0,
                    max: 5,
                })
                .on("change", this.car.recreate);
            this.car.debugFolder
                .addInput(this.car.options, "chassisHeight", {
                    label: "chassisHeight",
                    min: 0,
                    max: 5,
                })
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options.chassisOffset, "z", {
            //         min: 0,
            //         max: 5,
            //     })
            //     .on("change", this.car.recreate);
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelFrontOffsetDepth", {
            //         min: 0,
            //         max: 5,
            //     })
            //     .on("change", this.car.recreate);
            // this.car.debugFolder
            //     .addInput(this.car.options, "chassisMass", {
            //         min: 0,
            //         max: 1000,
            //     })
            //     .on("change", this.car.recreate);
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelBackOffsetDepth", {
            //         min: 0,
            //         max: 1000,
            //     })
            //     .on("change", this.car.recreate);
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelOffsetWidth", {
            //         min: 0,
            //         max: 5,
            //     })
            //     .on("change", this.car.recreate);
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelRadius", {
            //         min: 0,
            //         max: 2,
            //     })
            //     .on("change", this.car.recreate);
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelHeight", {
            //         min: 0,
            //         max: 2,
            //     })
            //     .on("change", this.car.recreate);
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelSuspensionStiffness", {
            //         min: 0,
            //         max: 300,
            //     })
            //     .on("change", this.car.recreate);
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelSuspensionRestLength", {
            //         min: 0,
            //         max: 5,
            //     })
            //     .on("change", this.car.recreate);
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelFrictionSlip", {
            //         min: 0,
            //         max: 30,
            //     })
            //     .on("change", this.car.recreate);
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelDampingRelaxation", {
            //         min: 0,
            //         max: 30,
            //     })
            //     .on("change", this.car.recreate);
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelDampingCompression", {
            //         min: 0,
            //         max: 30,
            //     })
            //     .on("change", this.car.recreate);
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelMaxSuspensionForce", {
            //         min: 0,
            //         max: 1000000,
            //     })
            //     .on("change", this.car.recreate);
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelRollInfluence", {
            //         min: 0,
            //         max: 1,
            //     })
            //     .on("change", this.car.recreate);
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelMaxSuspensionTravel", {
            //         min: 0,
            //         max: 5,
            //     })
            //     .on("change", this.car.recreate);
            ...
            //     .addInput(
            //         this.car.options,
            //         "wheelCustomSlidingRotationalSpeed",
            //         {
            //             min: -45,
            //             max: 45,
            //         }
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "wheelMass", {
            //         min: 0,
            //         max: 1000,
            //     })
            //     .on("change", this.car.recreate);
            ...
            // this.car.debugFolder
            //     .addInput(this.car.options, "controlsSteeringSpeed", {
            //         min: 0,
            //         max: 0.1,
            //     })
            //     .on("change", this.car.recreate);
            // this.car.debugFolder.addInput(
            //     this.car.options,
            //     "controlsSteeringMax",
            //     {
            //         min: 0,
            ...
            this.car.debugFolder.addInput(
                this.car.options,
                "controlsSteeringQuad"
            );
            this.car.debugFolder.addInput(
                this.car.options,
                "controlsAcceleratingSpeed",
                {
                    min: 0,
                    max: 30,
                }
            ...
            this.car.debugFolder.addInput(
                this.car.options,
                "controlsAcceleratingSpeedBoost",
                {
                    min: 0,
                    max: 30,
                }
            ...
            this.car.debugFolder.addInput(
                this.car.options,
                "controlsAcceleratingQuad"
            );
            this.car.debugFolder.addInput(
                this.car.options,
                "controlsBrakeStrength",
                {
                    min: 0,
                    max: 5,
                }
            ...
            this.car.debugFolder
                ...
                .on("click", this.car.recreate);
            this.car.debugFolder
                .addButton({
                    title: "jump",
                    label: "action", // optional
                })
                .on("click", this.car.jump);
        }
    }
