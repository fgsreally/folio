...
export default class Shadows {
    constructor(_options) {
        ...
        this.color = this.config.shadow || "#d04500";
        ...
        if (this.debug) {
            ...
            this.debugFolder.addInput(this, "alpha", {
                min: 0,
                max: 1,
            });
            this.debugFolder.addInput(this, "maxDistance", {
                min: 0,
                max: 10,
            });
            this.debugFolder.addInput(this, "distancePower", {
                min: 0,
                max: 5,
            });

            this.debugFolder
                .addInput(this, "wireframeVisible")
                .on("change", () => {
            ...
            this.debugFolder.addInput(this, "color").on("change", () => {
    ...
    setSun() {
        ...
        if (this.debug) {
            ...
            folder
                .addInput(this.sun.position, "x", {
                    min: -10,
                    max: 10,
                })
                .on("change", this.sun.update);

            folder
                .addInput(this.sun.position, "y", {
                    min: -10,
                    max: 10,
                })
                .on("change", this.sun.update);
            ...
            folder
                .addInput(this.sun.position, "z", {
                    min: 0,
                    max: 10,
                })
                .on("change", this.sun.update);
            folder
                .addInput(this.sun.helper, "visible")
                .on("change", this.sun.update);
        }
    }
    ...
    setHelper() {
        ...
        if (this.debug) {
            ...
            folder.addInput(this.helper, "active").on("change", () => {
                this.helper.mesh.visible = this.helper.active;
